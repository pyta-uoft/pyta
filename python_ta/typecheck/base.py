...
class TypeConstraints:
    ...
    def _unify_generic(self, conc_tnode1: _TNode, conc_tnode2: _TNode,
                       ast_node: Optional[NodeNG] = None) -> TypeResult:
        ...
        # TODO: should the edges instead be between the original _TNodes?
        self.create_edges(conc_tnode1, conc_tnode2, ast_node)
