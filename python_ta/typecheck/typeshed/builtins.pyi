...
if sys.version_info >= (3,):
    ...
    class unicode(basestring, Sequence[unicode]):
        ...
        def endswith(
            self, suffix: Union[unicode, Tuple[unicode, ...]], start: int = ..., end: int = ...
        ) -> bool: ...
        ...
        def startswith(
            self, prefix: Union[unicode, Tuple[unicode, ...]], start: int = ..., end: int = ...
        ) -> bool: ...
...
class str(Sequence[str], _str_base):
    ...
    if sys.version_info >= (3,):
        def translate(
            self, table: Union[Mapping[int, Union[int, str, None]], Sequence[Union[int, str, None]]]
        ) -> str: ...
    else:
...
if sys.version_info >= (3,):
    class bytes(ByteString):
        ...
        def count(
            self, sub: Union[bytes, int], start: Optional[int] = ..., end: Optional[int] = ...
        ) -> int: ...
...
# Added to handle zip calls (see tests/test_type_inference/test_for.py::test_for_zip)
...
if sys.version_info >= (3,):
    ...
    def print(
        *values: object, sep: Text = ..., end: Text = ..., file: Optional[_Writer] = ...
    ) -> None: ...
...
if sys.version_info >= (3,):
    def sorted(
        __iterable: Iterable[_T], *, key: Optional[Callable[[_T], Any]] = ..., reverse: bool = ...
    ) -> List[_T]: ...
