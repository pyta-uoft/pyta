    ...
    def test_check_on_dir(self):
        ...
        for item in _inputs:
            try:
                ...
                assrtn_message = 'Exception raised when checking directory: ' \
                          '"{}".\n{}'.format(item, exc)
                self.fail(assrtn_message)

    def test_check_on_file(self):
        """Test files"""
        _inputs = [
            ['nodes/Name.py'],
        ...
        for item in _inputs:
            try:
                ...
                assrtn_message = 'Exception raised when checking: ' \
                          '"{}".\n{}'.format(item, exc)
                self.fail(assrtn_message)

    def test_check_on_bad_input(self):
