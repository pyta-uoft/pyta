...
def test_for_list():
    ...
    # TODO: x should have inferred type of int
    # x in module's environment is correctly unified, however in For's environment it is not..
    # is this okay or not what we want?
