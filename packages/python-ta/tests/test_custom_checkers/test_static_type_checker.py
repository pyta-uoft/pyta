...
DIR_PATH = os.path.normpath(
    os.path.join(
        ...
        "../../../../examples/custom_checkers/static_type_checker_examples/",
    )
)
...
class TestStaticTypeChecker(pylint.testutils.CheckerTestCase):
    ...
    def test_e9951_incompatible_argument_type(self) -> None:
        file_path = os.path.normpath(os.path.join(DIR_PATH, "e9951_incompatible_argument_type.py"))
    ...
    def test_e9952_incompatible_assignment(self) -> None:
        file_path = os.path.normpath(os.path.join(DIR_PATH, "e9952_incompatible_assignment.py"))
        mod = MANAGER.ast_from_file(file_path)
        with self.assertAddsMessages(
            pylint.testutils.MessageTest(
    ...
    def test_e9953_list_item_type_mismatch(self) -> None:
        file_path = os.path.normpath(os.path.join(DIR_PATH, "e9953_list_item_type_mismatch.py"))
        mod = MANAGER.ast_from_file(file_path)
        with self.assertAddsMessages(
            pylint.testutils.MessageTest(
    ...
    def test_e9954_unsupported_operand_types(self) -> None:
        file_path = os.path.normpath(os.path.join(DIR_PATH, "e9954_unsupported_operand_types.py"))
        mod = MANAGER.ast_from_file(file_path)
        with self.assertAddsMessages(
            pylint.testutils.MessageTest(
    ...
    def test_e9955_union_attr_error(self) -> None:
        ...
        file_path = os.path.normpath(os.path.join(DIR_PATH, "e9955_union_attr_error.py"))
        mod = MANAGER.ast_from_file(file_path)
        with self.assertAddsMessages(
            pylint.testutils.MessageTest(
    ...
    def test_e9956_dict_item_type_mismatch(self) -> None:
        file_path = os.path.normpath(os.path.join(DIR_PATH, "e9956_dict_item_type_mismatch.py"))
    ...
    def test_no_errors_in_static_type_checker_no_error(self) -> None:
        file_path = os.path.normpath(os.path.join(DIR_PATH, "static_type_checker_no_error.py"))
        mod = MANAGER.ast_from_file(file_path)
...
class TestStaticTypeCheckerCustomConfig(pylint.testutils.CheckerTestCase):
    ...
    def test_imports_no_error(self) -> None:
        """Imports a module with mypy errors, no errors raised."""
        file_path = os.path.normpath(os.path.join(DIR_PATH, "imports_no_error.py"))
        mod = MANAGER.ast_from_file(file_path)
        with self.assertNoMessages():
            self.checker.process_module(mod)
