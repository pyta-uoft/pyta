...
def test_list_comprehension1():
    ...
    # TODO: is this the correct expected type? num should be unified with the num in ListComp's local scope..?
    # TODO: since this is a ListComp expr, num should not exist in module's env? so module's should not be unified with
    # TODO: ListComp's?
