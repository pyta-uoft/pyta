...
class int(SupportsInt, SupportsFloat, SupportsComplex, SupportsAbs[int]):
...
class float(SupportsFloat, SupportsInt, SupportsComplex, SupportsAbs[float]):
...
class complex(SupportsComplex, SupportsAbs[float]):
    @overload
